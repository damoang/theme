...
if(IS_YC) {
	// 초기값
	$default['de_sms_cont1'] = isset($default['de_sms_cont1']) ? $default['de_sms_cont1'] : '';
	$default['de_admin_company_name'] = isset($default['de_admin_company_name']) ? $default['de_admin_company_name'] : '';
	$default['de_admin_company_tel'] = isset($default['de_admin_company_tel']) ? $default['de_admin_company_tel'] : '';
	$default['de_sms_use1'] = isset($default['de_sms_use1']) ? $default['de_sms_use1'] : '';
