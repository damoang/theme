...
?>
<div id="user-ui-custom" class="p-0">
    <div class="row align-items-center mt-5">
        <label class="col-form-label pb-0" style="text-align:center;">개인화면설정</label>
        <label class="col-form-label pt-0" style="text-align:center;">※ 현재 브라우저에만 저장됩니다.</label>
    </div>
    <ul class="nav nav-tabs ui-custom-tabs mb-2">
    ...
    <ul id="ui-custom-short-cut-ul" class="p-0 ui-custom-uls">
         <!-- 숫자 단축키 ------------------------------------------------------- -->
    ...
    <div id="ui-custom-default" class="p-0 ui-custom-uls d-none">
        ...
        <div class="ui-custom-item">
            <ul class="nav nav-tabs ui-custom-ul-tabs mb-2">
                <li class="nav-item ui-custom-ul-tab">
                    <a class="nav-link active" aria-current="page" href="#ui-custom-ul-setting">
                        설정
                    </a>
                </li>
                <li class="nav-item ui-custom-ul-tab">
            ...
            <ul id="ui-custom-ul-setting" class="p-0 ui-custom-ul-subs">
                <li class="list-group-item ui-custom-item mt-4">
                    <div class="row">
                        <label for="reg_show_width" class="col-sm-5 col-form-label" title="최대 화면 너비를 설정합니다.">화면너비(px)</label>
                        <div class="col-sm-7">
                ...
                <li class="list-group-item ui-custom-item">
                    <div class="row">
                        <label for="reg_font_size" class="col-sm-5 col-form-label" title="화면 기본 글씨크기를 설정합니다.">글씨 크기(em)</label>
                        <div class="col-sm-7">
                ...
                <li class="list-group-item ui-custom-item">
                    <div class="row">
                        <label for="reg_line_height" class="col-sm-5 col-form-label" title="화면 기본 글씨 높이를 설정합니다.">줄높이</label>
                        <div class="col-sm-7">
                ...
                <li class="list-group-item ui-custom-item">
                    <div class="row">
                        <label for="reg_menu_width" class="col-sm-5 col-form-label" title="메뉴의 너비 비율을 설정합니다.">메뉴너비(%)</label>
                        <div class="col-sm-7">
            ...
            <ul id="ui-custom-ul-menu" class="p-0 ui-custom-ul-subs d-none">
                <li class="list-group-item ui-custom-item mt-4">
                    <div class="row align-items-center">
            ...
            <ul id="ui-custom-ul-memo" class="p-0 ui-custom-ul-subs d-none">
                ...
                <li class="list-group-item ui-custom-item mt-2">
                    <div class="row align-items-center">
            ...
            <ul id="ui-custom-ul-quick" class="p-0 ui-custom-ul-subs d-none">
                <li class="list-group-item ui-custom-item mt-4">
                    <div class="row align-items-center">
    ...
    <ul id="ui-custom-list-ul" class="p-0 ui-custom-uls d-none">
        <li class="list-group-item ">
            <div class="row align-items-center">
    ...
    <ul id ="ui-custom-apply" class="p-0">
