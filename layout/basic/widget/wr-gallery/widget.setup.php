        ...
        <div class="row gx-2">
            ...
            <div class="col-md-10">
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-md-10">
                        <?php
                            $wset['grid'] = isset($wset['grid']) ? $wset['grid'] : 'g-3 row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4';
                        ?>
                        <textarea name="wset[grid]" rows="2" class="form-control"><?php echo $wset['grid'] ?></textarea>
                        <div class="form-text">
                            아이템 가로수 및 간격 등 설정
