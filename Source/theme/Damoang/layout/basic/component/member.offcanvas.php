		...
		<div class="px-3">
			<?php if($is_member) { ?>
					...
					<div class="flex-grow-1 ps-1">
						<div class="d-flex gap-1">
							...
							<?php if ($is_admin === 'super') { ?>
								<div class="ms-auto">
									<button type="button" class="widget-setup btn btn-basic btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="위젯설정">
										<i class="bi bi-magic"></i>
										<span class="visually-hidden">위젯설정</span>
									</button>
								</div>
								<div>
									<a href="<?php echo correct_goto_url(G5_ADMIN_URL) ?>" class="btn btn-basic btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="관리자">
				...
				<div class="row g-2 mb-3">
					...
					<div class="col-3">
						<a href="<?php echo G5_BBS_URL ?>/noti.php" data-bs-toggle="offcanvas" data-bs-target="#notiOffcanvas" aria-controls="notiOffcanvas" class="memo btn btn-basic btn-sm w-100 pb-2 pt-1">
