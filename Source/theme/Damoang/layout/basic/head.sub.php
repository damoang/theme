...
<?php
echo('<link rel="stylesheet" href="'.G5_THEME_URL.'/css/'.(G5_IS_MOBILE ? 'mobile' : 'default').'.css">');
echo('<link rel="stylesheet" href="'.G5_THEME_URL.'/css/nariya.css">');
echo('<link rel="stylesheet" href="'.LAYOUT_URL.'/css/style.css">');
echo('<link rel="stylesheet" href="'.G5_THEME_URL.'/css/bootstrap-icons.min.css">');
echo('<link rel="stylesheet" href="'.G5_JS_URL.'/font-awesome/css/font-awesome.min.css">');
echo('<link rel="canonical" href="'.$pset['href'].'">');
?>
<script>
