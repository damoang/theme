...
?>
<div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-start align-items-sm-center sns-wrap-32 sns-wrap-over" id="sns_register">
	<div class="py-1">
		<i class="bi bi-link-45deg"></i>
		SNS 계정으로 가입
	</div>
	<div class="sns-wrap py-1">
