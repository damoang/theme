...
if(isset($boset['comment_rows']) && $boset['comment_rows']) {
    include_once(NA_PATH.'/comment.page.php');
	return;
}
...
$sql = " select * from $write_table where wr_parent = '$wr_id' and wr_is_comment = 1 $na_comment_where order by wr_comment, wr_comment_reply ";
