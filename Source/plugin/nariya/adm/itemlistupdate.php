...
if ($post_act_button == "선택수정") {
    ...
    for ($i=0; $i< $count_post_chk; $i++) {
        ...
        $p_it_9       = isset($_POST['it_9'][$k])       ? clean_xss_tags($_POST['it_9'][$k], 1, 1)        : '';
        ...
        $sql = "update {$g5['g5_shop_item_table']}
                   set ca_id          = '".sql_real_escape_string($p_ca_id)."',
                       ...
                       it_9			  = '".sql_real_escape_string($p_it_9)."',
...
goto_url(G5_ADMIN_URL."/shop_admin/itemlist.php?sca=$sca&amp;sst=$sst&amp;sod=$sod&amp;sfl=$sfl&amp;stx=$stx&amp;page=$page");