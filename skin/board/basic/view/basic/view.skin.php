    ...
    <div class="d-flex gap-1 align-items-start pt-2 px-3 small">
      ...
      <div>
        ...
        <div class="ms-auto">
          ...
          <?php } ?>
          <?php if ($delete_href) { ?>
          <a href="<?php echo $delete_href ?>" onclick="del(this.href); return false;" class="btn btn-basic btn-sm">
            <i class="bi bi-trash"></i>
          </a>
          <?php } ?>
        </div>
  ...
  <div class="d-flex align-items-center gap-1 border-top px-3 pt-2 mb-4">
    ...
    <div>
      <a href="<?php echo $prev_href ?>" class="btn btn-basic btn-sm"
        title="<?php echo $prev_wr_subject;?> <?php echo date("Y.m.d", strtotime($prev_wr_date)) ?>" title="이전글">
    ...
    <div>
      <a href="<?php echo $next_href ?>" class="btn btn-basic btn-sm"
        title="<?php echo $next_wr_subject;?> <?php echo date("Y.m.d", strtotime($next_wr_date)) ?>" title="다음글">
