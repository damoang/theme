...
if (isset($wr_id) && $wr_id) {
	// SEO 이미지 체크
	$write['seo_img'] = ($write['wr_10'] && na_check_img($write['wr_10'])) ? na_url($write['wr_10']) : na_url(na_wr_img($bo_table, $write));
	$write['is_singo'] = ($singo_count && in_array($wr_id, $singo_write)) ? true : false;
	$write['is_chadan'] = ($chadan_count && $write['mb_id'] && in_array($write['mb_id'], $chadan_list)) ? true : false;
