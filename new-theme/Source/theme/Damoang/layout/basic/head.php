	...
	<header id="header-navbar" class="site-navbar">
		<div class="container px-3">
			<div class="d-flex gap-3 align-items-center">
				<div>
					<a href="<?php echo HOME_URL ?>" style="display: flex; " class="fs-2 fw-bold typologo">
						다모앙
					</a>
				</div>
				<div class="ms-auto">
...
?>
	<div id="main-wrap" class="bg-body">
		<div class="container px-0 px-sm-3<?php echo (IS_ONECOL) ? ' py-3' : ''; ?> shadow-sm p-3 mb-5 rounded">
		...
		?>
			...
			<div class="row row-cols-1 row-cols-md-2 g-3">
				...
				<div class="order-2 col-md-8 col-lg-9">
					<div class="shadow-sm p-3 mb-5 rounded sticky-top py-3">
						<?php
							// 페이지 타이틀
							include_once LAYOUT_PATH.'/component/title.php';
						?>
